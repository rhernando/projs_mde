...
/**
 * This is the item provider adapter for a {@link petrinet.petri.Place} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PetriPackage.Literals.PLACE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PetriPackage.Literals.PLACE__TOKENS,
				 true,
				 false,
				 false,
	...
	protected void addConnectionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Place_connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Place_connection_feature", "_UI_Place_type"),
				 PetriPackage.Literals.PLACE__CONNECTION,
				 true,
				 false,
				 true,
				 null,
