...
public class PetriAdapterFactory extends AdapterFactoryImpl {
	...
	protected PetriSwitch<Adapter> modelSwitch =
		new PetriSwitch<Adapter>() {
			...
			@Override
			public Adapter caseRedPetri(RedPetri object) {
				return createRedPetriAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link petrinet.petri.Place <em>Place</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link petrinet.petri.Transition <em>Transition</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link petrinet.petri.RedPetri <em>Red Petri</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createRedPetriAdapter() {
		return null;
	}
