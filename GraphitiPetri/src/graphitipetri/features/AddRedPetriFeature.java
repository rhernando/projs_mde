...
public class AddRedPetriFeature extends AbstractAddFeature implements
		IAddFeature {

	public AddRedPetriFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canAdd(IAddContext context) {
		...
		return context.getNewObject() instanceof RedPetri &&  context.getTargetContainer() instanceof Diagram;
	}

	@Override
	public PictogramElement add(IAddContext context) {

		RedPetri newRed = (RedPetri)context.getNewObject();
		...
		Text text = gaService.createText(shape, "RedPetri");
